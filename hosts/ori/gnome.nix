  ...
  dconf = {
    ...
    settings = {
      ...
      "org/gnome/shell/extensions/auto-move-windows" = {
        application-list = "['firefox.desktop:1', 'discord.desktop:3', 'jetbrains-clion.desktop:2', 'jetbrains-goland.desktop:2', 'jetbrains-pycharm.desktop:2', 'jetbrains-idea.desktop:2', 'spotify.desktop:5']";
      };
      ...
      "org/gnome/shell" = {
        ...
        enabled-extensions = "['horizontal-workspaces@gnome-shell-extensions.gcampax.github.com', 'org.gnome-shell.desktop-icons', 'auto-move-windows@gnome-shell-extensions.gcampax.github.com']";
      };
    };
  };
}
