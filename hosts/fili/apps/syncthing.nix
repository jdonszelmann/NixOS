      ...
      settings = {
        devices = {
          ...
          "ori" = {
            ...
            id =
              "GQ3BEZA-NPJNM4J-ZEDGEHB-W6XEPQR-SSHEQDA-R6ODPPX-T5ZTO7J-FSCAEQE";
            introducer = true;
          ...
          "nori" = {
            id =
              "HKTBAV2-ADDOOIQ-VRFW7QZ-4I5EYYU-F5N3BX5-G3SVP3V-HAGCG6C-JPMHUAB";
            introducer = true;
            autoAcceptFolders = true;
          };
          "kili" = {
            id =
              "DRYPY6Q-SHIYZVD-J33UTDW-NWEQSVL-UHUXCVP-WPPADQP-XHRA3PQ-7FPA3AI";
            introducer = true;
            autoAcceptFolders = true;
          };
        };
